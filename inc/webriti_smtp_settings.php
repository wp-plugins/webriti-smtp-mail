	...
	<form method="post" action="#">		
		...
		<div style="  border-color: #C8C8C8;  border-style: solid; margin-top: 10px;    min-height: 40px;    padding-bottom: 0;    padding-left: 20px;   padding-right: 0;">
			...
			<div class="section">
				...
				<input id="smtp_ssl_ssl" type="radio" name="smtp_ssl" value="none" <?php checked('none', get_option('smtp_ssl')); ?> />
				<label for="smtp_ssl_ssl"><span><?php _e('No encryption.', 'webritismtp'); ?></span></label><br />			
				...
				<input id="smtp_ssl_ssl" type="radio" name="smtp_ssl" value="tls" <?php checked('tls', get_option('smtp_ssl')); ?> />
				<label for="smtp_ssl_ssl"><span><?php _e('Use TLS encryption. Only use if you are aware that your server uses this type of encryption. Most server uses SSL Encryption', 'webritismtp'); ?></span></label><br />				
			</div>
			<div class="section">
